...
public class AdapterTest extends JUnitSuite {
  ...
  public void shouldSendMessageFromUntypedToTyped() {
    TestKit probe = new TestKit(system);
    // FIXME can this be done without narrow? similar problem when using javadsl.ActorContext directly
  ...
  public void shouldWatchTypedFromUntyped() {
    ...
    // FIXME this is weird, ordinary cast to ActorRef<Ping> is not allowed, see also comment about narrow above
    ActorRef<Ping> typedRef2 = typedRef.upcast();
